...
dataset_train = datasets.ImageFolder('./traffic_sign_detection/train', transform)
# 对应文件夹的label
print(dataset_train.class_to_idx)
dataset_test = datasets.ImageFolder('./traffic_sign_detection/test', transform)
# 对应文件夹的label
...
class NoisyLabelCorrectionLayer(nn.Module):
    ...
    def forward(self, y_hat_i, y_i):
        ...
        #self.weight = nn.Parameter(torch.Tensor(y_hat_i.shape[0], y_hat_i.shape[0]))
        #self.bias = nn.Parameter(torch.Tensor(y_hat_i.shape[0], y_hat_i.shape[1]))
